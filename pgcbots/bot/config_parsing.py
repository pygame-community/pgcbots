...
import click
from .constants import LOG_LEVEL_NAMES

from pgcbots.utils import ParserMapping, ParserMappingValue, _raise_exc
...
def parse_extensions(
    ...
    if ignore_all_extensions:
        ...
        default_extensions = cfg.get("_default_extensions", [])
...
def parse_log_level(
    ...
    if log_level is not None and log_level not in LOG_LEVEL_NAMES:
        raise ParserMapping.ParsingError(
