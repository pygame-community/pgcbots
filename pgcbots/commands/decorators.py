...
import pgcbots.commands as sc_commands
    ...
    *,
    ...
    prefix : str | None, optional
        ...
        cls (type[commands.FlagConverter], optional): The class to use as a base class for
          ...
          `pgcbots.commands.converters.FlagConverter`, flags with annotation `tuple[T[, ...]]`
...
def with_config_kwargs(
    ...
    `pgcbots.commands.(AutoSharded)Bot.get_extension_config(...)` function's
    output mapping, if available.

    Parameters
    ----------
    setup_or_teardown : Callable[[pgcbots.commands.Bot | pgcbots.commands.AutoShardedBot, ...], None]
